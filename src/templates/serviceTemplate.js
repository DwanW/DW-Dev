  ...
  return (
    <Layout location={location}>
      ...
      <SectionHeader>
        ...
        <SectionHead>How our service support your business</SectionHead>
      </SectionHeader>
      <SectionContainer>
        {benefits.map((obj, idx) => (
          <CardContainer key={idx}>
            <CardImg>
              <Image
                wrapperStyle={{ maxHeight: "260px" }}
                filename={obj.benefitImg.replace("/img/", "")}
              />
            </CardImg>
            <Card>
        ...
        {workflow.map((obj, idx) => (
          <CardContainer key={idx}>
            <CardImg>
              <Image
                wrapperStyle={{ maxHeight: "260px" }}
                filename={obj.stepImg.replace("/img/", "")}
              />
            </CardImg>
            <Card>

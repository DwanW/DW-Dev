...
const AboutPage = ({ location }) => {
  ...
  return (
    <Layout location={location}>
      ...
      <AboutDescription>
        we are group of passionate developers who love technology and modern
        innovation. Our mission is to bring the most value in web development to
        people who needs it.
      </AboutDescription>
      {data.allAboutJson.nodes.map((node, idx) => {
        return (
          <div key={idx}>
            <Image
              filename={node.image}
              wrapperStyle={{ width: 350, margin: "auto" }}
            />

...
const PrivacyPolicy = () => (
    <PrivacyPolicyContainer>
      ...
      <p>
        DW Interactive Dev, LLC ("us", "we", or "our") operates the
        https://www.dwinteractivedev.com website (the "Service").
      </p>
      <p>
      ...
      <h3>Use of Data</h3>
      <p>DW Interactive Dev uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        DW Interactive Dev will take all steps reasonably necessary to ensure
      ...
      <p>
        DW Interactive Dev may disclose your Personal Data in the good faith
        belief that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>
          To protect and defend the rights or property of DW Interactive Dev
        </li>
        <li>
      ...
      <ul>
        <li>By email: info@dwinteractivedev.com</li>
      </ul>
    </PrivacyPolicyContainer>
)
